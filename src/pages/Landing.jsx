...
const Landing = () => {
  return (
    <div className=" text-black flex w-full flex-col items-center justify-center">
      <section style={{ backgroundImage: `url(${bg})` }} className="text-center bg-cover bg-center h-full bg-no-repeat w-full px-8 min-h-screen py-10">
        <h1 className="text-4xl font-extrabold mb-6">Welcome to STONEWRECKODDS.</h1>
        <p className="text-lg text-zinc-600 mb-6">We are a Zambian/UK based record label that fuses Hip-Hop with mind-blowing word play.</p>
      ...
      <section className='min-h-screen flex justify-center items-center w-full text-white bg-zinc-800'>
        content here
      </section>
    </div>
  )
