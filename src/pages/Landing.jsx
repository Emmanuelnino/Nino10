        ...
        <div className='mt-10 gap-6 items-center justify-center flex w-full'>
          <a href="" className='group'>
            <svg
              ...
              height="2.5em"
              width="2.5em"
              className='justify-center transition transform delay-300 duration-300 group-hover:scale-105 w-full flex group-hover:text-green-400 text-zinc-700'
          ...
          <a href="">
            <svg
              ...
              height="2.5em"
              width="2.5em"
              className='justify-center w-full flex text-zinc-700'
            ...
            <a href="" className='md:text-sm text-xs text-zinc-500'>
              <p>Youtube</p>
            </a>
          </a>
